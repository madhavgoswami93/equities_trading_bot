...
class MLBacktester:
    ...
    def __repr__(self):
        ...
        return rep.format(
            self.symbol, "Logistic Regression", self.start, self.end, self.tc
        )
    ...
    def test_strategy(self, start_train, end_train, start_test, end_test, lags=5):
        ...
        self.data_subset["strategy_minus_ptc"] = (
        ...
        self.data_subset["cstrategy_actual"] = (
            self.data_subset["strategy_minus_ptc"].cumsum().apply(np.exp)
        )
    ...
    def plot_results(self):
        ...
        if self.results is None:
            ...
            self.results[["creturns", "cstrategy", "cstrategy_actual"]].plot(
...
if __name__ == "__main__":
    ...
    perf_after_commission, pef_wo_comm, outperformance_buy_hold = mlb.test_strategy(
        "2019-01-01", "2020-01-01", "2020-01-01", "2020-08-31", 15
    )

    print("Performance without considering commission :", pef_wo_comm)
    print("Performance after considering commission : ", perf_after_commission)
    print("Outperformance to Buy and hold :", outperformance_buy_hold)
